...
export declare const NegativeMinimum: () => h.JSX.Element;
export declare const CustomIncrement: () => h.JSX.Element;
export declare const OnValueInput: () => h.JSX.Element;
export declare const WithTextboxNumeric: () => h.JSX.Element;
